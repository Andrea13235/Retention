...
**Retention** is created and maintained solely by
**Andrea Barretta** — sole author of all the code in this repository.
Powered by [RetentionVolt](https://retentionvolt.com).
...
| `@modelcontextprotocol/sdk` (npm) | MIT | MCP server exposing the pipeline tools |
...
See [LICENSE.md](LICENSE.md) for the license of Retention itself.
